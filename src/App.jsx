                    ...
                    {showDesktopMenu && (
                        <>
                            ...
                            <div className="absolute top-full right-0 mt-2 w-56 bg-white shadow-xl rounded-lg border z-40 overflow-hidden animate-in fade-in zoom-in-95">
                                ...
                                {libsLoaded && (<><button onClick={() => { handleExportClick('jpg'); setShowDesktopMenu(false); }} className="w-full text-left px-4 py-2 flex items-center gap-2 hover:bg-slate-50 text-slate-700 border-b border-slate-50"><ImageIcon className="w-4 h-4" /> Guardar como JPG</button><button onClick={() => { handleExportClick('pdf'); setShowDesktopMenu(false); }} className="w-full text-left px-4 py-2 flex items-center gap-2 hover:bg-slate-50 text-slate-700"><FileIcon className="w-4 h-4" /> Guardar como PDF</button></>)}
